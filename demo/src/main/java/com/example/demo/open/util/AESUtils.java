...
public class AESUtils {
	...
	public static String encrypt(String text, String aesKey, String nonce) throws Exception {
		try {
	...
	public static String decrypt(String text, String aesKey, String nonce) throws Exception {
		try {
			SecretKey secretKey = getSecretKey(aesKey);
	...
	public static void main(String[] args) throws Exception {
		String text = "hello";
		String aesKey = "123456dsffd";
		String nonce = "123456";
		String encrypt128 = encrypt(text, aesKey, nonce);
		System.out.println(encrypt128);
		String decrypt128 = decrypt(encrypt128, aesKey, nonce);
